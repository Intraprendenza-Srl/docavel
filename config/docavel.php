...
return [
    ...
    | If the setting is null, Docavel will reside under the same domain as the
    ...
    /*
    |--------------------------------------------------------------------------
    | Docavel Route Middleware
    |--------------------------------------------------------------------------
    |
    | These middleware will be assigned to the Docavel route, giving you
    | the chance to add your own or change the docavel middleware.
    |
     */
    ...
    'title' => 'Docavel API Reference',

    'description' => 'Docavel Api secification and documentation.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Docavel collection/output path
    |--------------------------------------------------------------------------
    |
    ...
    |
    |    'resources/views/vendor/docavel/languages/*.blade.php',
    |
    ...
    /*
    |--------------------------------------------------------------------------
    | Docavel routes: The routes for which documentation should be generated.
    |--------------------------------------------------------------------------
    |
