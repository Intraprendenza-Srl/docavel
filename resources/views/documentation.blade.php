...
<html>
  <head>
    <title>{{config('docavel.title')}}</title>
  ...
  <body>
    ...
    <script>
      RedocPro.init(
        "{{config('docavel.output') . "/openapi.json"}}", {
          "showConsole": true,
          "pathInMiddlePanel": true,
          "redocExport": "RedocPro",
          "layout": { "scope": "section" },
          "unstable_externalDescription": '{{route('docavel.info')}}',
          "hideDownloadButton" : {{config('docavel.hide_download_button') ?: 0}}
        },
